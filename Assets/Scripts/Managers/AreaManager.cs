...
public class AreaManager : Singleton<AreaManager>
{
    ...
    // 플레이어 현재 영역
    private AreaType playerCurrentAreaType;
    public AreaBase PlayerCurrentArea => areaDictionary[playerCurrentAreaType];
    ...
    public List<AreaType> FindPath(AreaType start, AreaType target)
    {
        ...
        Queue<AreaType> queue = new Queue<AreaType>();  // 탐색할 AreaType 큐
